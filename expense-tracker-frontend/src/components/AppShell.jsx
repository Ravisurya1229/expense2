      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/70 dark:border-slate-800/60 bg-white/80 dark:bg-slate-900/70 backdrop-blur">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-brand-600 to-pink-500" />
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 text-white dark:bg-white dark:text-slate-900">
              <User className="w-4 h-4"/> <span className="text-sm">Demo</span>
            </button>
          </div>
        </div>
      </header>
